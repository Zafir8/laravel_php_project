<x-app-layout>
    <div class="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow-lg rounded-lg p-6">
            <h2 class="text-3xl font-bold mb-6 text-center text-indigo-600">Parent Dashboard</h2>
            <div class="bg-white shadow-md rounded-lg p-6">
                <h3 class="text-2xl font-bold text-gray-900 mb-6">Your Children's Subscriptions</h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        @foreach($upcomingRides as $ride)
                            <div class="bg-green-100 p-6 rounded-lg shadow-md">
                                ...
                                <form action="{{ route('cancel.ride', $ride->id) }}" method="POST" class="mt-4">
                                    @csrf
                                    @method('PATCH')
